...
output_file_name = "random_peptides_0to1000.csv"
...
def evolve(Identifier, Best_peptide, Best_score):
    ...
    New_score_percentage = 0
    Best_score_percentage = int(Best_score*100)
    Best_evol_count = 0
  
    while New_score_percentage < 100 and Best_evol_count < 100: #Best_evol_count is the number of iterations without visible improvement before the loop breaks
